    ...
    <div className="w-full flex gap-4">
      <form onSubmit={handleFormSubmit} className="flex w-full">
        ...
        <button
          ...
          className={`bg-green-500 hover:bg-green-600 rounded-l-none text-white py-2 px-4 flex items-center focus:outline-none rounded-lg ${
      ...
      <div className="w-full">
        <h3 className="text-2xl">Speech Result</h3>
        <p className="whitespace-pre-wrap mt-4 bg-gray-400 text-white rounded-lg p-4">{speechResult || 'N/A'}</p>
      </div>
    </div>
  );
};
